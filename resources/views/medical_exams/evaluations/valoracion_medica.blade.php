        ...
        <form action="#" method="POST" class="space-y-8">
            ...
            <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="block text-[10px] font-black uppercase text-slate-400 ml-2">Percentil IMC</label>
                ...
                <input type="hidden" name="imc_calculado" :value="imc">
                <input type="hidden" name="imc_clasificacion" :value="clasificacion">
                <input type="hidden" name="imc_percentil" :value="percentil">
                <input type="hidden" name="imc_referencia" value="percentil_imc_edad_sexo_estimado">
            </div>
