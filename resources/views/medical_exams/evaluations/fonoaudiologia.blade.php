...
<div class="mb-10 flex items-center justify-between">
    <div>
        <span class="text-[10px] font-black text-emerald-600 uppercase tracking-[0.3em] mb-2 block">Área de Especialidad</span>
        <h2 class="text-4xl font-black text-slate-900 tracking-tighter uppercase leading-none">
            Valoración: <span class="text-emerald-700">Fonoaudiología</span>
        </h2>
...
<form action="{{ route('medical_exams.store_evaluation', $medical_exam) }}" method="POST" class="space-y-8">
    ...
    <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-emerald-100">
        <div class="flex items-center mb-6">
            ...
            <label class="text-xs font-black text-emerald-600 uppercase tracking-[0.2em]">Diagnóstico y Plan de Acción</label>
        </div>
        ...
        <div class="mt-10 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <button type="submit" class="w-full md:w-auto bg-emerald-600 text-white px-12 py-5 rounded-2xl font-black shadow-xl shadow-emerald-200/60 hover:bg-emerald-700 hover:-translate-y-1 active:scale-95 transition-all uppercase text-sm">
                Guardar Valoración
            </button>
        </div>
    </div>
